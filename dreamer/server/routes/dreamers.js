...
router.post('/register',(req,res) => {
    ...
    DreamerCollection.findOne({email:req.body.email})
        .then((user) => {
            if(user) {
...
router.post("/login", (req, res) => {
    DreamerCollection.findOne({ email: req.body.email }).then((user) => {
      if (!user) {
...
router.get('/customers',(req,res) => {
    ...
    DreamerCollection.find({role:"Customer"},(errors,results) => {
...
router.get('/customer/view/:email',(req,res) => {
    ...
    DreamerCollection.findOne({email:req.params.email},(errors,results) => {
        errors ? res.send(errors) : res.send(results);
    })
})
...
router.delete('/customer/:email',(req,res) => {
    ...
    DreamerCollection.findOneAndDelete({email:req.params.email},(errors,results) => {
        errors ? res.send(errors) : res.send(results);
    })
})
...
router.get('/admin',(req,res) => {
    ...
    DreamerCollection.find({role:"Admin"},(errors,results) => {
        errors ? res.send(errors) : res.send(results);
    })
})
